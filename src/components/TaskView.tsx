...
export default function TaskView(props: TaskViewProps) {
            ...
            >
                ...
                >
                    {accountTasks.length ? (
                        ...
                        <Typography fontSize={"125%"} sx={{ textAlign: "center" }}>
                            You don't have access to any tasks. Start by creating a task.
                        </Typography>
                    )}
                </SortableContext>
            </DndContext>
    ...
    function handleDragEnd(event: DragEndEvent) {
        ...
        setAccountTasks(accountTasks => {
            ...
            const oldIndex = accountTasks.findIndex(
                accountTask => active.id === accountTask.task_id
            );
